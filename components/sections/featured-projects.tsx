          ...
          {featured.map((project, index) => (
            <MotionWrapper key={project.slug} delay={index * 0.1} className="bg-background">
              <Link
                ...
                className="corner-bracket group block h-full p-8 md:p-10 transition-colors hover:bg-secondary/40"
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className="h-4 w-4 text-muted-foreground arrow-nudge group-hover:[animation-play-state:paused] group-hover:text-accent transition-all" />
                  </div>
                </div>
              </Link>
            </MotionWrapper>
